...
# all_availableprdcts=[i.get("name") for i in items ]
# print(all_availableprdcts)
...
# costly product using list comprehesion not get max product name only get max number so use lambda fn
